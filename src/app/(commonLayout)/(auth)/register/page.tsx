...
const RegisterPage = () => {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(45,212,191,0.18),_transparent_40%),linear-gradient(135deg,_#f8fffe,_#f4f8fb)] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-6 overflow-hidden rounded-[32px] border border-slate-200/70 bg-white/80 p-4 shadow-[0_25px_80px_-25px_rgba(15,23,42,0.35)] backdrop-blur lg:grid-cols-[1.05fr_0.95fr] lg:p-6">
        <div className="flex flex-col justify-between rounded-[24px] bg-gradient-to-br from-teal-700 via-teal-600 to-cyan-600 p-8 text-white sm:p-10">
        ...
        <div className="rounded-[24px] border border-slate-200/80 bg-white/90 p-6 sm:p-8">
